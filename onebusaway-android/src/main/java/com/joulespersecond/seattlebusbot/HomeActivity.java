...
public class HomeActivity extends BaseMapActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            Application.getAnalytics().reportEvent("ui_action", "button_press", "Stops");

            Intent myIntent = new Intent(this, MyStopsActivity.class);
            startActivity(myIntent);
            return true;
        } else if (id == R.id.find_route) {
            Application.getAnalytics().reportEvent("ui_action", "button_press", "Routes");

            Intent myIntent = new Intent(this, MyRoutesActivity.class);
            startActivity(myIntent);
            return true;
        } else if (id == R.id.view_trips) {
            Application.getAnalytics().reportEvent("ui_action", "button_press", "Reminders");
